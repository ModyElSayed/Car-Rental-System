<?php
	...
	$yearb = $_SESSION['yearb'];
	
	$sql_query = "SELECT Reserve_Id, Plate_Id, Model, Brand, Car.Year, Price, Customer.First, Customer.Last, SSN, Email, DOB, Zip, Area, City, Country, Payment_Type, Pickup_Location, Reservation_Date FROM Reservation NATURAL JOIN Customer NATURAL JOIN Car NATURAL JOIN Cus_Address NATURAL JOIN Address WHERE year >= '".$yeara."' AND year <= '".$yearb."'";
